...
class Nhelper(base: Context?) : ContextWrapper(base) {
    ...
    fun sendHighPriorityNotification(title: String?, body: String?, activityName: Class<*>?) {
        ...
        val notification: Notification = Notification.Builder(this, CHANNEL_ID) //                .setContentTitle(title)
            //                .setContentText(body)
            .setSmallIcon(R.drawable.ic_launcher_background)
            .setPriority(Notification.PRIORITY_DEFAULT)
            .setStyle(Notification.BigTextStyle().setSummaryText("summary").setBigContentTitle(title).bigText(body))
