...
class GeofenceHelper(base: Context?) : ContextWrapper(base) {
    ...
    fun getGeofence(ID: String?, latLng: LatLng, radius: Float, transitionTypes: Int): Geofence {
        return Geofence.Builder().setCircularRegion(latLng.latitude, latLng.longitude, radius).setRequestId(ID!!).setTransitionTypes(transitionTypes)
    ...
    fun getPendingIntent(): PendingIntent? {
        ...
        val intent = Intent(this, GeofenceHelper::class.java)
